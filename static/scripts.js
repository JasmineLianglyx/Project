...
function updatePageContent() {
    ...
    if (visitCount % 2 == 0) {
        ...
        // Even visitCount: Show other sections based on the step in the 8-step loop
        switch (visitCount % 8) {
            case 1:
                shapSection.style.display = 'block'; // Static explanation
                counterfactualSection.style.display = 'block';
                break;
            case 3:
                interactivePanel.style.display = 'block'; // Interactive explanation
                predictButton.style.display = 'block';
                counterfactualSection.style.display = 'block';
                break;
            case 5:
                shapSection.style.display = 'block'; // Static + counterfactual explanation
                counterfactualSection.style.display = 'block';
                break;
            case 7:
                interactivePanel.style.display = 'block'; // Interactive + counterfactual explanation
                counterfactualSection.style.display = 'block';
                predictButton.style.display = 'block';
                incrementLoopCount();
                break;
